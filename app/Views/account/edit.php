<section class="account-page">
    <div class="account-page-header">
        ...
        <h1 class="account-page-title">Редагування профілю</h1>
    </div>
    ...
    <div class="edit-card">
        <form method="post" action="/account/update" class="auth-form" autocomplete="on">
            ...
            <div class="form-group">
                ...
                <p class="form-hint">Email змінити неможливо</p>
            </div>
            ...
            <div class="form-divider">
                <span>Зміна пароля (опціонально)</span>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-input-wrap">
                    ...
                    <input
                        ...
                        name="new_password"
                        class="form-input"
                        placeholder="Залиште порожнім, якщо не змінювати"
